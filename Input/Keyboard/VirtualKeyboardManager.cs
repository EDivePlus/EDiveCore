...
{
    public class VirtualKeyboardManager : AServiceBehaviour<VirtualKeyboardManager>
    {
        [SerializeField]
        private VirtualKeyboardController _Keyboard;
        
        [SerializeReference]
        private ICondition _AvailableCondition;
        ...
        {
            return _AvailableCondition == null || _AvailableCondition.Evaluate();
        }
        ...
        {
            if (_AutoAddKeyboardDisplay && !inputField.GameObject.TryGetComponent<VirtualKeyboardDisplay>(out _))
            {
                var keyboardDisplay = inputField.GameObject.AddComponent<VirtualKeyboardDisplay>();
        ...
        public VirtualKeyboardController ShowKeyboard(AInputFieldWrapper inputField, bool observeCharacterLimit = false)
        {
            if (_Keyboard == null)
                return null;
        ...
        public VirtualKeyboardController ShowKeyboard(string text)
        {
            if (_Keyboard == null)
                return null;
        ...
        public VirtualKeyboardController ShowKeyboard(bool clearKeyboardText = false)
        {
            if (_Keyboard == null)
                return null;
        ...
        private void FaceKeyboardAtTarget(Transform target)
        {
            ...
            _Keyboard.transform.rotation = Quaternion.LookRotation(forward, Vector3.up);
        }
