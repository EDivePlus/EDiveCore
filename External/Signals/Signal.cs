...
namespace EDIVE.External.Signals
{
    ...
    public class Signal<T, U> : BaseSignal, ISignal
    {
        ...
        public void AddOnce(Action<T, U> callback) { OnceListener = this.AddUnique(OnceListener, callback); }
    ...
    public class Signal<T, U, V> : BaseSignal, ISignal
    {
        ...
        public void AddOnce(Action<T, U, V> callback) { OnceListener = this.AddUnique(OnceListener, callback); }
    ...
    public class Signal<T, U, V, W> : BaseSignal, ISignal
    {
        ...
        public void AddOnce(Action<T, U, V, W> callback) { OnceListener = this.AddUnique(OnceListener, callback); }
