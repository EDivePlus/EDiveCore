...
namespace EDIVE.VoiceRecording
{
    public static class SavWav
    {
        ...
        public static void Save(string filename, AudioClip clip, bool trim = true)
        {
...
#if UNITY_EDITOR
            var folder = "_NonVersioned/VoiceRecordings";
            Debug.Log("Saving audio files from the editor is not implemented.");
            return;
#elif UNITY_ANDROID || UNITY_IOS //&& !UNITY_EDITOR
        var folder = Application.persistentDataPath + "/" + Application.productName + "/VoiceRecordings";
#else
        var folder = "VoiceRecordings";
#endif
