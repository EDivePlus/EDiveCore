// URP 17.3 LitInput plus UV decal slots. Re-copy on URP upgrade.
...
half _Surface;
float4 _UVDecal0Rect;
float4 _UVDecal0Params;
half4 _UVDecal0Tint;
float4 _UVDecal1Rect;
float4 _UVDecal1Params;
half4 _UVDecal1Tint;
float4 _UVDecal2Rect;
float4 _UVDecal2Params;
half4 _UVDecal2Tint;
float4 _UVDecal3Rect;
float4 _UVDecal3Params;
half4 _UVDecal3Tint;
