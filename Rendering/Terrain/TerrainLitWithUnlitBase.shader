...
Shader "EDIVE/Terrain/Lit With Unlit Base"
{
    Properties
    {
        [Toggle(_TERRAIN_UNLIT_BASE)] _UnlitBase("Unlit Base", Float) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment SplatmapFragmentUnlitBase
            ...
            #pragma shader_feature_local_fragment _TERRAIN_UNLIT_BASE
            ...
            #include "TerrainLitWithUnlitBasePasses.hlsl"
            ENDHLSL
        }
